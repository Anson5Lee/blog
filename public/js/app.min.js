...
!function(){function o(o,n,c,t){o.articleData=n,o.onSubmit=function(){return o.Error="",o.comment.commentBody?void o.addComment(n.articleId,o.comment):(o.Error="评论内容不能为空！",!1)},o.addComment=function(n,c){t.addCommentByArticleId(n,{commentBody:c.commentBody}).success(function(n){o.modal.close(n)})},o.modal={close:function(o){c.close(o)},cancel:function(){c.dismiss("cancel")}}}angular.module("AnsonBlog").controller("commentModalCtrl",o),o.$inject=["$scope","articleData","$uibModalInstance","ArticleService"]}();
!function(){function c(c,e,t){c.checkSafeHTML=function(c){return t.trustAsHtml(c)},e.getAllArticles().success(function(e){console.log(e.data),c.articles=e.data})}angular.module("AnsonBlog").controller("homeCtrl",c),c.$inject=["$scope","ArticleService","$sce"]}();
...
!function(){function e(e,n,t){e.pageHeader="注册新用户",console.log(t.search()),e.returnPage=t.search().page||"/",e.credentials={},e.onSubmit=function(){n.register(e.credentials).then(function(){t.search("page",null),t.path(e.returnPage)})}}angular.module("AnsonBlog").controller("registerCtrl",e),e.$inject=["$scope","AuthenticationService","$location"]}();
...
!function(){function n(n,e){function o(e){n.localStorage["Blog-Token"]=e}function t(e){return n.localStorage["Blog-Token"]}function r(n){return e.post("/api/user/register",n).success(function(n){o(n.token)})}function i(n){return e.post("/api/user/login",n).success(function(n){o(n.token)})}function u(e){n.localStorage.removeItem("Blog-Token")}function a(){var e=t();if(e){var o=JSON.parse(n.atob(e.split(".")[1]));return o.exp>Date.now()/1e3}return!1}function c(){if(a()){var e=t(),o=JSON.parse(n.atob(e.split(".")[1]));return{email:o.email,name:o.name}}}return{saveToken:o,getToken:t,register:r,login:i,logout:u,isLoggedIn:a,currentUser:c}}angular.module("AnsonBlog").factory("AuthenticationService",n),n.$inject=["$window","$http"]}();

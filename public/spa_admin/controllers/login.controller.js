(function() {
  angular
    ...
    .constant('uploadUrl', '/api/admin/upload')
        ...
        link: function(scope, element, attrs) {
          ...
          angular.element(publish).on('click', function(event) {
            ...
            $http.post('/api/article', {
              title: scope.title,
              author: 'Anson',
              thumbnailUri: scope.thumbnailUri,
              previewBanner: scope.previewBanner,
              mainBanner: scope.mainBanner,
    ...
    function mainController($scope, $http, uploadUrl) {
      ...
      $scope.getScreen = function () {
        return $scope.current == "文章"
          ? "spa_admin/views/adminArticles.html" : "spa_admin/views/adminUsers.html";
      };
    }
})()
